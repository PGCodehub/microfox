...
When working with AI-generated content that needs to be published to Notion, you can combine the markdown parser with the Notion SDK. This is particularly useful when you have AI models generating markdown-formatted content that needs to be structured in Notion pages.

Here's an example of creating a Notion page with AI-generated content:
...
async function createNotionPageWithAIContent(databaseId: string, title: string, markdownContent: string) {
  // Convert markdown content to Notion blocks
  const blocks = markdownToBlocks(markdownContent);

  // Create the page with converted blocks
  const response = await notion.pages.create({
    ...
    children: blocks // The converted markdown blocks will be added as children
  });

  return response;
}

// Example usage with AI-generated content:
const aiGeneratedMarkdown = `
# My AI Generated Article

This is an introduction paragraph generated by AI.

## Key Points

* First important point
* Second important point
  * Sub-point with _emphasis_
  * Another sub-point
...
- Working with AI language models that generate markdown-formatted content
- Building automated content pipelines that publish to Notion
- Converting structured AI outputs into well-formatted Notion pages
- Maintaining consistent formatting when bulk-creating pages from AI sources

The markdown parser will handle all the formatting, lists, headings, and special blocks (like callouts) in your AI-generated content, ensuring it appears properly structured in Notion.
